...
const variantStyles = {
  solid: {
    ...
    green: 'relative overflow-hidden bg-emerald-500 text-white before:absolute before:inset-0 active:before:bg-transparent hover:before:bg-white/10 active:bg-emerald-600 active:text-white/80 before:transition-colors',
    white:
