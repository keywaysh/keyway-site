    ...
    <div className="flex items-center justify-between py-3 border-b border-gray-200 last:border-0">
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-3">
          ...
          <span className="px-2 py-0.5 text-xs font-medium bg-gray-100 rounded-full text-gray-600">
            {secret.environment}
          </span>
        </div>
...
export function SecretRowSkeleton() {
  return (
    <div className="flex items-center justify-between py-3 border-b border-gray-200 last:border-0 animate-pulse">
